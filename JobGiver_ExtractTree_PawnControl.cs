...
namespace emitbreaker.PawnControl
{
    ...
    /// </summary>
    public class JobGiver_ExtractTree_PawnControl : JobGiver_RemoveBuilding_PawnControl
    {
        ...
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            return Utility_JobGiverManager.StandardTryGiveJob<JobGiver_ExtractTree_PawnControl>(
                pawn,
