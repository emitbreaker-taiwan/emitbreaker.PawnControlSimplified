...
namespace emitbreaker.PawnControl
{
    ...
    /// </summary>
    public class JobGiver_Construction_ConstructDeliverResourcesToBlueprints_PawnControl : JobGiver_Common_ConstructDeliverResourcesToBlueprints_PawnControl
    {
